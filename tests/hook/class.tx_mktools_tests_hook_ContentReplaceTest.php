...
class tx_mktools_tests_hook_ContentReplaceTest extends tx_rnbase_tests_BaseTestCase
{
    ...
    public function contentPostProcAll()
    {
        ...
        $contentReplacer = new tx_mktools_hook_ContentReplace();
    ...
    public function contentPostProcOutput()
    {
        ...
        $typoScriptFrontendController->expects(self::once())
            ->method('isINTincScript')
            ->willReturn(true);
        $contentReplacer = new tx_mktools_hook_ContentReplace();
        $contentReplacer->contentPostProcOutput([], $typoScriptFrontendController);
     ...
     * @test
     */
    public function contentPostProcOutputIfReplacingNotEnabled()
    {
        $typoScriptFrontendController = $this->getTypoScriptFrontendController(false);
        $typoScriptFrontendController->expects(self::once())
            ->method('isINTincScript')
     ...
     * @test
     */
    public function contentPostProcOutputIfNoUserIntObjects()
    {
        $typoScriptFrontendController = $this->getTypoScriptFrontendController();
        $typoScriptFrontendController->expects(self::once())
            ->method('isINTincScript')
     ...
     * @test
     */
    public function contentPostProcOutputIfNoUserIntObjectsAndReplacingNotEnabled()
    {
        $typoScriptFrontendController = $this->getTypoScriptFrontendController(false);
        $typoScriptFrontendController->expects(self::once())
            ->method('isINTincScript')
